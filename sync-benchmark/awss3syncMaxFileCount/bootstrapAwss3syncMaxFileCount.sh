        ...
        "collect_list": [
          {
            ...
            "log_group_name": "/bench/awss3sync-maxfilecount",
...
# Benchmark scripts
mkdir -p /opt/bench/awss3syncMaxFileCount
aws s3 cp s3://diploma-scripts/benchmarkMaxFileCount.sh /opt/bench/benchmarkMaxFileCount.sh
aws s3 cp s3://diploma-scripts/awss3syncMaxFileCount.sh /opt/bench/awss3syncMaxFileCount/awss3syncMaxFileCount.sh

chmod +x /opt/bench/benchmarkMaxFileCount.sh
chmod +x /opt/bench/awss3syncMaxFileCount/awss3syncMaxFileCount.sh
cd /opt/bench
sudo -E ./benchmarkMaxFileCount.sh awss3syncMaxFileCount
