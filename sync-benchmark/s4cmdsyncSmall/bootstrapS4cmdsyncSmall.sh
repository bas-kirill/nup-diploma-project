        ...
        "collect_list": [
          {
            ...
            "log_group_name": "/bench/s4cmdsync-small",
...
aws s3 cp s3://diploma-scripts/s4cmdsyncSmall.sh /opt/bench/s4cmdsyncSmall/s4cmdsyncSmall.sh

chmod +x /opt/bench/benchmarkSmall.sh
chmod +x /opt/bench/s4cmdsyncSmall/s4cmdsyncSmall.sh

cd /opt/bench
sudo -E ./benchmarkSmall.sh s4cmdsyncSmall
