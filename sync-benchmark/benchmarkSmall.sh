...
if [[ $# -lt 1 || $# -gt 2 ]]; then
  echo "Usage: $0 {awss3syncSmall|s3cmdsync|s4cmdsync|rclonesync|mcmirror} [folder_name]"
  exit 1
fi
...
case "$sync_tool" in
  awss3syncSmall)
    source "./awss3syncSmall/awss3syncSmall.sh"
    sync_function="awss3syncSmall"
    ;;
  rclonesyncSmall)
    source "./rclonesyncSmall/rclonesyncSmall.sh"
    sync_function="rclonesyncSmall"
    ;;
  s3cmdsyncSmall)
    source "./s3cmdsyncSmall/s3cmdsyncSmall.sh"
    sync_function="s3cmdsyncSmall"
    ;;
  s4cmdsyncSmall)
    source "./s4cmdsyncSmall/s4cmdsyncSmall.sh"
    sync_function="s4cmdsyncSmall"
    ;;
  mcmirrorSmall)
    source "./mcmirrorSmall/mcmirrorSmall.sh"
    sync_function="mcmirrorSmall"
    ;;
  *)
    echo "Unknown sync tool: $sync_tool"
    echo "Valid options are: awss3sync, s3cmdsync, s4cmdsync, rclonesync, mcmirror"
    exit 1
    ;;
esac
...
scenarios=(
  "Min_Dataset_Size 160 1"
  "Minimal_Unit 3000 1"
  "Small_Static 109000 1"
  "Small_Multi_File 679000 441"
  "Medium_Static 6000000 1"
  "Medium_Distributed 32000000 5676"
  "Medium_High_Density 50000000 14253"
  "Large_Static 380000000 1"
  "Large_Chunked 487000000 454"
  "1GB_Moderate_Load 1000000000 23267"
  "1GB_Extreme_Load 1000000000 1055905"
  "19GB_Heavy_Load 19000000000 256381"
)
