        ...
        "collect_list": [
          {
            ...
            "log_group_name": "/bench/rclonesync-large",
...
# Benchmark scripts
mkdir -p /opt/bench/rclonesyncLarge
aws s3 cp s3://diploma-scripts/benchmarkLarge.sh /opt/bench/benchmarkLarge.sh
aws s3 cp s3://diploma-scripts/rclonesyncLarge.sh /opt/bench/rclonesyncLarge/rclonesyncLarge.sh

chmod +x /opt/bench/benchmarkLarge.sh
chmod +x /opt/bench/rclonesyncLarge/rclonesyncLarge.sh
cd /opt/bench
sudo -E ./benchmarkLarge.sh rclonesyncLarge
