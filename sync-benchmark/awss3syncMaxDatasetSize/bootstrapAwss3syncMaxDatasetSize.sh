        ...
        "collect_list": [
          {
            ...
            "log_group_name": "/bench/awss3sync-maxdatasetsize",
...
# Benchmark scripts
mkdir -p /opt/bench/awss3syncMaxDatasetSize
aws s3 cp s3://diploma-scripts/benchmarkMaxDatasetSize.sh /opt/bench/benchmarkMaxDatasetSize.sh
aws s3 cp s3://diploma-scripts/awss3syncMaxDatasetSize.sh /opt/bench/awss3syncMaxDatasetSize/awss3syncMaxDatasetSize.sh

chmod +x /opt/bench/benchmarkMaxDatasetSize.sh
chmod +x /opt/bench/awss3syncMaxDatasetSize/awss3syncMaxDatasetSize.sh
cd /opt/bench
sudo -E ./benchmarkMaxDatasetSize.sh awss3syncMaxDatasetSize
