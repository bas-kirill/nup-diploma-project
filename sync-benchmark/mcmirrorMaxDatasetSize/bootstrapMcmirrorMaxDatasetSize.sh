        ...
        "collect_list": [
          {
            ...
            "log_group_name": "/bench/mcmirror-maxdatasetsize",
...
# Benchmark scripts
mkdir -p /opt/bench/mcmirrorMaxDatasetSize
aws s3 cp s3://diploma-scripts/benchmarkMaxDatasetSize.sh /opt/bench/benchmarkMaxDatasetSize.sh
aws s3 cp s3://diploma-scripts/mcmirrorMaxDatasetSize.sh /opt/bench/mcmirrorMaxDatasetSize/mcmirrorMaxDatasetSize.sh

chmod +x /opt/bench/benchmarkMaxDatasetSize.sh
chmod +x /opt/bench/mcmirrorMaxDatasetSize/mcmirrorMaxDatasetSize.sh

cd /opt/bench
sudo -E ./benchmarkMaxDatasetSize.sh mcmirrorMaxDatasetSize
