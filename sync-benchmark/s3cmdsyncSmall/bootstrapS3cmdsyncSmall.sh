        ...
        "collect_list": [
          {
            ...
            "log_group_name": "/bench/s3cmdsync-small",
...
# Benchmark scripts
mkdir -p /opt/bench/s3cmdsyncSmall
cd /opt/bench/s3cmdsyncSmall
aws s3 cp s3://diploma-scripts/benchmarkSmall.sh /opt/bench/benchmarkSmall.sh
aws s3 cp s3://diploma-scripts/s3cmdsyncSmall.sh /opt/bench/s3cmdsyncSmall/s3cmdsyncSmall.sh

chmod +x /opt/bench/benchmarkSmall.sh
chmod +x /opt/bench/s3cmdsyncSmall/s3cmdsyncSmall.sh
cd /opt/bench
sudo -E ./benchmarkSmall.sh s3cmdsyncSmall
