...
case "$sync_tool" in
  awss3syncMaxDatasetSize)
    source "./awss3syncMaxDatasetSize/awss3syncMaxDatasetSize.sh"
    sync_function="awss3syncMaxDatasetSize"
    ;;
  rclonesyncMaxDatasetSize)
    source "./rclonesyncMaxDatasetSize/rclonesyncMaxDatasetSize.sh"
    sync_function="rclonesyncMaxDatasetSize"
    ;;
  s3cmdsyncMaxDatasetSize)
    source "./s3cmdsyncMaxDatasetSize/s3cmdsyncMaxDatasetSize.sh"
    sync_function="s3cmdsyncMaxDatasetSize"
    ;;
  s4cmdsyncMaxDatasetSize)
    source "./s4cmdsyncMaxDatasetSize/s4cmdsyncMaxDatasetSize.sh"
    sync_function="s4cmdsyncMaxDatasetSize"
    ;;
  mcmirrorMaxDatasetSize)
    source "./mcmirrorMaxDatasetSize/mcmirrorMaxDatasetSize.sh"
    sync_function="mcmirrorMaxDatasetSize"
    ;;
  *)
    echo "Unknown sync tool: $sync_tool"
    echo "Valid options are: awss3syncMaxDatasetSize, rclonesyncMaxDatasetSize, s3cmdsyncMaxDatasetSize, s4cmdsyncMaxDatasetSize, mcmirrorMaxDatasetSize"
    exit 1
    ;;
esac
...
scenarios=(
  "Max_Dataset_Size 146000000000 1281167"
