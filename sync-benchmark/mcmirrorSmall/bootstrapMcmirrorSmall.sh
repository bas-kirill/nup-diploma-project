        ...
        "collect_list": [
          {
            ...
            "log_group_name": "/bench/mcmirror-small",
...
# Benchmark scripts
mkdir -p /opt/bench/mcmirrorSmall
aws s3 cp s3://diploma-scripts/benchmarkSmall.sh /opt/bench/benchmarkSmall.sh
aws s3 cp s3://diploma-scripts/mcmirrorSmall.sh /opt/bench/mcmirrorSmall/mcmirrorSmall.sh

chmod +x /opt/bench/benchmarkSmall.sh
chmod +x /opt/bench/mcmirrorSmall/mcmirrorSmall.sh

cd /opt/bench
sudo -E ./benchmarkSmall.sh mcmirrorSmall
