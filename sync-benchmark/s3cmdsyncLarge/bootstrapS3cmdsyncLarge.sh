        ...
        "collect_list": [
          {
            ...
            "log_group_name": "/bench/s3cmdsync-large",
...
# Benchmark scripts
mkdir -p /opt/bench/s3cmdsyncLarge
cd /opt/bench/s3cmdsyncLarge
aws s3 cp s3://diploma-scripts/benchmarkLarge.sh /opt/bench/benchmarkLarge.sh
aws s3 cp s3://diploma-scripts/s3cmdsyncLarge.sh /opt/bench/s3cmdsyncLarge/s3cmdsyncLarge.sh

chmod +x /opt/bench/benchmarkLarge.sh
chmod +x /opt/bench/s3cmdsyncLarge/s3cmdsyncLarge.sh
cd /opt/bench
sudo -E ./benchmarkLarge.sh s3cmdsyncLarge
